...
"$gh_bin" api --method PUT "repos/$repository/actions/permissions" --input - >/dev/null <<<"$actions_permissions"
"$gh_bin" api --method PUT "repos/$repository/actions/permissions/selected-actions" --input - >/dev/null <<<"$selected_actions"
"$gh_bin" api --method PUT "repos/$repository/actions/permissions/workflow" --input - >/dev/null <<<"$workflow_permissions"
